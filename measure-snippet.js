...
function selectFloorPrefixedHoCandidate(pool, wantDong, wantHo) {
...
// 표기이므로 건드리지 않는다.
function buildAdminDongLotRequeryPlan(pre, status) {
...
function pickAdminDongLotCandidate(hits, plan) {
  if (!plan) return null;
