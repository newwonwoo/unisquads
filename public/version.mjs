...
export const RELEASED_AT = "2026-08-09T01:05:00+09:00";

export const CHANGELOG = Object.freeze([
  Object.freeze({
    version: "1.21.0",
    released_at: "2026-08-09T01:05:00+09:00",
    summary: "층 접두 호 재해석 — 원문 \"2102호\"를 등기부 \"202호(층2)\"로 되돌린다 (광평동 실측 17행, 층 정합성·중의성 기권)"
  }),
  Object.freeze({
    version: "1.20.0",
  ...
  Object.freeze({
    ...
    summary: "호 유형 접두 정규화(논현 아파트904 유형) + 원문 지X-N 층-호 재해석(갈산 하나상가) — 실측 코퍼스 34곳 확장"
  }),
  Object.freeze({
    version: "1.17.1",
    released_at: "2026-08-08T02:20:00+09:00",
    summary: "동 매핑 충돌 가드 — 대상 동이 직접 요청되거나 두 요청 동이 한 등기부 동으로 수렴하면 기권 (중앙 합본기재 오확정 실측 차단)"
  }),
  Object.freeze({
    version: "1.17.0",
    released_at: "2026-08-08T01:56:43+09:00",
    summary: "동↔지번 재배치 모듈 — 요청 동이 확정 지번 등기부에 없고 JUSO detBdNmList가 다른 한 지번으로만 매핑하면 그 지번 재조회 (창신 109동=462-2 실측)"
  }),
  Object.freeze({
    version: "1.16.2",
    released_at: "2026-08-08T01:32:25+09:00",
    summary: "소거 매핑에 호 집합 커버리지 가드(80%) — 용당 12→123 오확정 실측 차단"
  }),
  Object.freeze({
    version: "1.16.1",
    released_at: "2026-08-08T01:25:22+09:00",
    summary: "검증 동 매핑에 소거법 추가 — 주거동 N-1 일치 시 남는 하나끼리 매핑 (앵커 상충 시 기권)"
  }),
  Object.freeze({
    version: "1.16.0",
    released_at: "2026-08-08T01:08:37+09:00",
    summary: "검증 동 매핑 전파 — 동무시 앵커 2건+ 수렴 시 요청동↔등기부동 매핑 재판정 (원조 실측 24앵커)"
  }),
  Object.freeze({
    version: "1.15.0",
