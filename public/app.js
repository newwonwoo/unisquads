...
import {
  ...
  runNaverLotRescue
} from "./address-failed-decision.mjs";
import {
  countRestored,
  detectExportLayout,
...
// 주소 실패 재조회 체인은 address-failed-decision.mjs로 꺼내 두었다.
// 정제율 모듈 간섭 감사(audit-address-interference)가 이 체인을 실측 픽스처로
// 그대로 돌린다 — 감사 대상이 곧 운영 코드다. resolve/validateRegion은 앱의
// 실제 구현을 주입한다.
const addressRequeryCtx = () => ({ resolve, validateRegion });
const attemptAdminDongLotRequery = (result, pre, clients) =>
  runAdminDongLotRequery(result, pre, clients, addressRequeryCtx());
const attemptFailedAddressRequery = (result, pre, clients) =>
  runFailedAddressRequery(result, pre, clients, addressRequeryCtx());
const attemptNaverLotRescue = (pnuFailed, pre, clients) =>
  runNaverLotRescue(pnuFailed, pre, clients, addressRequeryCtx());
...
function AddrRefineTestGui() {
  ...
  ), regResult && (regResult.status === "RESOLVED" || regResult.status === "MULTIPLE") && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: C.faint, textAlign: "center", marginTop: 10 } }, "\u203B \uB2E8\uC77C \uC870\uD68C \uACB0\uACFC\uB294 \uD654\uBA74 \uD45C\uC2DC\uC6A9\uC785\uB2C8\uB2E4. \uC5D1\uC140 \uC800\uC7A5\uC740 \uC77C\uAD04 \uD0ED\uC5D0\uC11C \uC9C0\uC6D0\uB429\uB2C8\uB2E4.")), tab === "batch" && /* @__PURE__ */ React.createElement("section", null,
  ...
  }), savedProgress && /* @__PURE__ */ React.createElement("div", { style: {
